...
#
# Generated by Vivado on Sat Aug 06 03:31:59 +0530 2022
...
# Script info
echo -e "output_buffer.sh - Script generated by export_simulation (Vivado v2021.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L fifo_generator_v13_2_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot output_buffer xil_defaultlib.output_buffer xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="E:/Simulations/Xilinx/Vivado/2021.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
