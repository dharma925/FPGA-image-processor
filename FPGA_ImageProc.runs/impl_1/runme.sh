...
HD_PWD='C:/Users/Dharma/Desktop/InternPreps/Projects/FPGA_ImageProc/FPGA_ImageProc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log image_proc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source image_proc.tcl -notrace
