...
HD_PWD='C:/Users/Dharma/Desktop/InternPreps/Projects/FPGA_ImageProc/FPGA_ImageProc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_proc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source image_proc.tcl
